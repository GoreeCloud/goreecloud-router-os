...
| P1 | GL.iNet Brume 3 (GL-MT5000) ARM64 hardware qualification | Development | Development hardware profile, fail-closed readiness validator, non-mutating stock-firmware discovery collector, privacy/status report validator, and fixture safety tests implemented on the active candidate branch | Repository CI and direct physical-hardware evidence required; no bootable image, install profile, recovery proof, or Supported status accepted |
